...
import './Polarizacao.css'
import Header from '../Header/Header'

export default function Polarizacao({ setCircuito }) {
    ...
    <div className="content">
      <Header />
        <div className="imageContent">
            <img className="ContentImg addColor"  src="./cc.png" alt="" />
            <img className="ContentImg" onClick={setView} src="./polari.png" alt="" />
